...
import { ReflectorPlane } from '@/components/canvas/Examples'
import { ScrollControls, PerspectiveCamera, Environment, Lightformer } from '@react-three/drei'
import { Canvas } from '@react-three/fiber'
// import { SunTsu } from '@/components/canvas/Examples'
    ...
    <>
      <div className='mx-auto flex w-full flex-col flex-wrap items-center md:flex-row  lg:w-4/5'>
        ...
        <div className='flex w-full flex-col items-start justify-center p-12 text-center md:w-2/5 md:text-left'>
          <p className='w-full uppercase text-slate-100 z-10'>0x65fFf8e4dC2d46C4959dC5a006F089528055438D</p>
          <h1 className='my-4 text-5xl font-bold leading-tight text-slate-50 z-10 font-SEVEN'>MOON TZU</h1>
          <p className='mb-8 text-2xl leading-normal text-slate-100 z-10'>The Art of Ape.</p>
        </div>
